            ...
            <div className={styles.register}>
                <form className={styles.registerForm} onSubmit={submitHandler}>
                    ...
                    <div className={styles.formSection}>
                        ...
                        <input className={styles.registerInput} type="password" placeholder="Enter student's password..."
                            value={password}
                    ...
                    <div className={styles.formSection}>
                        ...
                        <input className={styles.registerInput} type="text" placeholder="Enter father's name..."
                            value={fatherName}
